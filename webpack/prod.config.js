...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      { test: /\.less$/, loader: ExtractTextPlugin.extract("style", "css?importLoaders=2&sourceMap!postcss-loader!less?outputStyle=expanded&sourceMap=true&sourceMapContents=true") },
